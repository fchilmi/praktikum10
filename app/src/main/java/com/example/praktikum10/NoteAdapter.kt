...
class NoteAdapter: ListAdapter<Note, NoteAdapter.NoteHolder>(DIFF_CALLBACK) {
    companion object{
        private val DIFF_CALLBACK = object : DiffUtil.ItemCallback<Note>() {
            ...
            override fun areContentsTheSame(oldItem: Note, newItem: Note): Boolean {
                return oldItem.title == newItem.title && oldItem.descripton == newItem.descripton && oldItem.priority == newItem.priority
            }
        }
    }
    ...
    override fun onBindViewHolder(holder: NoteAdapter.NoteHolder, position: Int) {
        ...
        holder.textViewDescription.text = currentNote.descripton
    }
